                ...
                <div className="svc-con">
                    ...
                    <div className="svc-heading">
                        ...
                        <h1 className="svc-title">
                            Choose your <span>perfect wash.</span>
                        </h1>
                    </div>
                    ...
                    <div className="svc-grid">
                        {services.map((service, index) => {
                            ...
                            return (
                                <div
                                    key={service.id}
                                    className={`svc-card ${featured ? 'featured' : ''}`}
                                >
                                    {featured && (
                                    ...
                                    <div className="svc-desc">
                                        {service.description || 'Professional car wash service with premium products and attention to detail.'}
                                    </div>

                                    <div className="svc-price-row">
                                        <div>
                                            <span className="svc-price">${service.price}</span>
                                            <span className="svc-price-sub">/visit</span>
                                        </div>
                                    ...
                                    <Link
                                        href={route('ai.chat')}
                                        className={`svc-btn ${featured ? 'primary' : 'secondary'}`}
                                    >
                                        {featured ? '🤖 Book with AI' : 'Book Now →'}
                                    </Link>
                                </div>
                            );
                        })}
